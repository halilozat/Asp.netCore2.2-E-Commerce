...
namespace ShopApp.WebUI.Controllers
{
    ...
    public class CartController : Controller
    {
        ...
        public IActionResult Checkout()
        {
            ...
            //orderModel.PaymentTypes = EnumPaymentTypes.CreditCart;

            ViewBag.PaymentTypes = Enum.GetValues(typeof(EnumPaymentTypes));
        ...
        //public IActionResult GetPaymentTypeValue(int id)
        //{
        //    return Json(id);
        //}
        ...
        private void SaveOrder(OrderModel model, Payment payment, string userId)
        {
            ...
            order.PaymentTypes = model.PaymentTypes;
        ...
        private Payment PaymentProcess(OrderModel model)
        {
            ...
            options.ApiKey = "sandbox-fluMRB1NjmuwWfflqj4zjUH2a6hy9xfp";
            options.SecretKey = "sandbox-Xcz1WgPvmm1aBX3rxt1b1Ifa6O399tK8";
        ...
        {
            var orders = _orderService.GetOrders(_userManager.GetUserId(User)).OrderByDescending(x => x.OrderDate); 
